<aside
   class="bg-[#452EBC] dark:bg-neutral-900 border-r border-slate-300 dark:border-neutral-700 w-[18%] h-full fixed top-0 left-0 max-w-[264px] py-6 px-4 overflow-auto">

   <div class="flex items-center gap-2.5 min-w-9 mb-8 px-3">
      <img src="https://readymadeui.com/logo-alt.svg" alt="Company logo" class="h-9 w-auto" />
      <h1 class="text-2xl font-bold text-white">SchoolMS</h1>
   </div>

   <nav aria-label="Primary sidebar navigation">
      <ul class="space-y-2 text-sm text-slate-200 dark:text-slate-400 font-medium">
         <li>
            <a href="dashboard.php" aria-current="page"
               class="flex items-center gap-2.5 hover:text-slate-900 dark:hover:text-slate-50 hover:bg-[#7860E6] dark:hover:bg-neutral-800 rounded-md px-3 py-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500">
      ...
      <div class="mt-4">
         <div class="text-violet-400 dark:text-slate-50 text-sm font-semibold px-3">Actions</div>
         <ul class="mt-3 space-y-1 text-sm text-slate-200 dark:text-slate-400 font-medium">
            <li>
               <a href="#"
                  class="flex items-center gap-2.5 hover:text-slate-900 dark:hover:text-slate-50 hover:bg-[#7860E6] dark:hover:bg-neutral-800 rounded-md px-3 py-2 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500">
                  <svg xmlns="http://www.w3.org/2000/svg" class="size-[18px] fill-current overflow-visible"
