...
$sql = "SELECT
        ...
        JOIN users AS teacher
            ON courses.teacherID = teacher.user_id
        JOIN users AS student
            ON enrollments.studentID = student.user_id
...
<main class="ml-[18%] w-[82%] min-h-screen">
             ...
             <!-- header -->
         <header
            class="flex py-8 sticky top-0 w-full bg-white  px-6 dark:border-neutral-700 dark:bg-neutral-900 min-h-[68px] z-20"
            aria-label="header">
            <div class="flex flex-wrap items-center gap-4 w-full">
                <div class="flex flex-col gap-4">
                    <h1 class="text-xl text-slate-900 font-bold dark:text-slate-50">Students in Web Development</h1>
                  <!-- Search Box -->
            ...
            <a href="javascript:history.back()"
               class="h-10 inline-flex items-center gap-2 whitespace-nowrap px-4 py-1.5 bg-slate-600 hover:bg-slate-700 text-white text-sm font-medium rounded-lg shadow-sm transition-colors">
          ...
          <table class="min-w-full divide-y divide-slate-100">
            <thead>
              <tr>
                ...
                <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">Enrolled On</th>
            ...
            <tbody class="divide-y divide-slate-200">
              ...
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo $row['studentName']; ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo $row['email']; ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo $row['enrolled_at']; ?></td>
