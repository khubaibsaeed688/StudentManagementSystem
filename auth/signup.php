...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirm_password) {
        ...
        $sql = "INSERT INTO `users`(`username`, `email`, `password`, `phone`, `role`) 
                VALUES ('$username', '$email', '$hashed_password', '$phone', 'student')";
              ...
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <form class="space-y-4 md:space-y-6" action="signup.php" method="post">
                      ...
                      <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                          Already have an account? <a href="login.php" class="font-medium text-[#2563eb] hover:underline dark:text-primary-500">Login here</a>
                      </p>
                  </form>
              </div>
          </div>
