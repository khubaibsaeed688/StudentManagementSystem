...
<div id="popup-modal" tabindex="-1" class=" overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white border border-slate-200 shadow-xl rounded-xl p-4 md:p-6">
            ...
            <a href="manage_users.php" class="absolute top-3 end-2.5 text-slate-500 bg-transparent hover:bg-slate-100 hover:text-slate-900 rounded-base text-sm w-9 h-9 ms-auto inline-flex justify-center items-center" data-modal-hide="popup-modal">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <div class="flex items-center space-x-4 justify-center">
                    ...
                    <a href="delete_user.php?id=<?php echo $user_id; ?>&confirm=yes"
