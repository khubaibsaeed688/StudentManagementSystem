...
<main class="ml-[18%] w-[82%] min-h-screen">
         ...
         <div class="flex justify-between px-6 pb-4">
            <div class="flex flex-col gap-1">
                ...
                <p class="text-sm text-slate-700 dark:text-slate-50">Welcome back, Admin 👋</p>
            </div>
            <button
                type="button"
                class="inline-flex items-center gap-2 text-white bg-blue-600 border border-transparent hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 shadow-sm font-medium text-sm px-4 py-1.5 rounded-lg focus:outline-none transition-colors">
           ...
           <div class="p-4 ">
              ...
              <div class="grid grid-cols-2 gap-4 mb-4">
                 <div
                    class="block rounded-lg bg-white p-6 text-surface shadow-sm dark:bg-surface-dark dark:text-white">
