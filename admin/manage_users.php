    ...
    <main class="ml-[18%] w-[82%] min-h-screen">
      ...
      <header
        ...
        <div class="flex flex-wrap items-center gap-4 w-full">
          <h1 class="text-xl text-slate-900 font-bold dark:text-slate-50">Manage Users</h1>
        </div>
          ...
          <table class="min-w-full divide-y divide-slate-100">
            <thead>
              <tr>
                ...
                <th scope="col" class="px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase">P.Number</th>
            ...
            <tbody class="divide-y divide-slate-200">
              ...
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo $row['username']; ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo $row['email']; ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo $row['phone']; ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo $row['role']; ?></td>
