        ...
        <main class="ml-[18%] w-[82%] min-h-screen">
            ...
            <header
                ...
                <div class="flex flex-wrap items-center gap-4 w-full">
                    <h1 class="text-xl text-slate-900 font-bold dark:text-slate-50">Manage Enrollments</h1>
                </div>
          ...
          <table class="min-w-full divide-y divide-slate-100">
            ...
            <tbody class="divide-y divide-slate-200">
              ...
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo $row['courseName']; ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo $row['teacherName']; ?></td>
